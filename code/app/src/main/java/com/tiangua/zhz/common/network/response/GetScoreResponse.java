...
import com.tiangua.zhz.model.ApplyCashModel;
 ...
 */
public class GetScoreResponse extends IHttpReqTaskListener {

    private PostResponse response = new PostResponse();
    Context context;
    IRequestCallback requestCallback;

    GetScoreResponse(Context context, IRequestCallback requestCallback){
