...
import com.tiangua.zhz.common.network.request.FetchGoodsRequest;
 ...
 */
public class FetchGoodsResponse extends IHttpReqTaskListener {

    private PostResponse response = new PostResponse();
    Context context;
    IRequestCallback requestCallback;

    FetchGoodsResponse(Context context, IRequestCallback requestCallback){
